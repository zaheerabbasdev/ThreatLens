...
/**
 * Attribution is inferred from shared TTPs (technique overlap) rather than
 * asserted directly against indicators/incidents — matches spec §41: AI/heuristics
 * may suggest a relationship, but it must stay clearly separate from
 * deterministic evidence such as an indicator match.
 */
